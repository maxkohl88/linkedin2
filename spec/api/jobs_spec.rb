describe LinkedIn::API::Jobs do
  ...
  context 'todo' do
    it "should be able to view a job listing" do
      pending "https://api.linkedin.com/v2/jobs/id=1586"
      subject.job(:id => 1586)
    end

    it "should be able to view its job bookmarks" do
      pending "https://api.linkedin.com/v2/people/~/job-bookmarks"
      subject.job_bookmarks
    end

    it "should be able to view its job suggestion" do
      pending "https://api.linkedin.com/v2/people/~/suggestions/job-suggestions"
